...
import { MapPin, User2Icon } from 'lucide-react-native';
            ...
            <View style={tw`bg-white rounded-b-xl p-3`}>
                ...
                <View style={tw`flex flex-row justify-between`}>
                    <View style={tw`flex-row items-center`}>
                        ...
                        <Text style={tw`text-lg font-medium text-gray-600`}>{data?.location}</Text>
                    </View>
                    <Text style={tw`text-lg font-medium text-gray-600`}>{data?.lease_cost}</Text>
